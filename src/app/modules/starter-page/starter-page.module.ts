...
import { ProdutividadePageComponent } from '../order/components/produtividade/produtividade.component';
    ...
    RouterModule.forChild([
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'propertySummary', component: PropertySummaryPageComponent2, canActivate: [RoleGuard]},
          { path: 'propertySummaryold', component: PropertySummaryPageComponent, canActivate: [RoleGuard]},
          { path: 'consumeDetails/:energyGroupId', component: ConsumeDetailsComponent, canActivate: [RoleGuard]},
          { path: 'consumeWeekDetails/:energyGroupId', component: ConsumeWeekDetailsComponent , canActivate: [RoleGuard]},
          { path: 'occupancyDetails/:energyGroupId', component: OccupancyDetailsComponent, canActivate: [RoleGuard]},
          { path: 'occupancyWeekDetails/:energyGroupId', component: OccupancyWeekDetailsComponent, canActivate: [RoleGuard]},
          { path: 'engineering', component: EngineeringPageComponent , canActivate: [RoleGuard]},
          { path: 'it', component: ITPageComponent, canActivate: [RoleGuard]},
          { path: 'maintenance', component: MaintenancePageComponent, canActivate: [RoleGuard]},
          { path: 'housekeeping', component: HousekeepingPageComponent, canActivate: [RoleGuard]},
          { path: 'optimization', component: OptimizationPageComponent, canActivate: [RoleGuard]},
          { path: 'energyManagement', component: TelkonetPageComponent, canActivate: [RoleGuard]},
          { path: 'crm', component: CRMPageComponent, canActivate: [RoleGuard]},
          { path: 'usageReport', component: UsageReportPageComponent, canActivate: [RoleGuard]},
          { path: 'order', component: OrderPageComponent, canActivate: [RoleGuard]},
          { path: 'nps', component: NPSPageComponent, canActivate: [RoleGuard]},
          { path: 'produtividade', component: ProdutividadePageComponent, canActivate: [RoleGuard]},
          { path: 'roomControl', component: RoomControlPage, canActivate: [RoleGuard]}
        ]
      }
    ]),
    NvD3Module
