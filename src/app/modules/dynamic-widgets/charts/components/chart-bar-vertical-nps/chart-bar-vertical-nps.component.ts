...
export class ChartBarVerticalNpsComponent implements OnInit {
    ...
    @Output() clickBarVerticalNpsEvent: EventEmitter<{to: string, value: any}> = new EventEmitter<{to: string, value: any}>();
    @Output() restoreVerticalEvent: EventEmitter<void> = new EventEmitter<void>();
    @ViewChild('chartBarVerticalNpsCanvas', { static: true }) chartBarVerticalNpsCanvas: ElementRef<HTMLDivElement>;
