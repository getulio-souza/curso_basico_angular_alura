...
export class ChartBarVerticalComponent implements OnInit {
    ...
    @Output() clickBarVerticalEvent: EventEmitter<{to: string, value: any}> = new EventEmitter<{to: string, value: any}>();
    @Output() restoreVerticalEvent: EventEmitter<void> = new EventEmitter<void>();
    @ViewChild('chartBarVerticalCanvas', { static: true }) chartBarVerticalCanvas: ElementRef<HTMLDivElement>;
